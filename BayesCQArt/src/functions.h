...
void getpertsuff_new(tree& x, tree::tree_p pertnode, tree::npv& bnv, size_t oldc, xinfo& xi, dinfo& di, std::vector<sinfo>& svold, std::vector<sinfo>& svnew,  arma::vec GAMMA_QUANT,
                     arma::vec TAU_SQ_QUANT);
void getpertsuff_new(tree& x, tree::tree_p pertnode, tree::npv& bnv, size_t oldc, size_t oldvar, bool didswaplr, xinfo& xi, dinfo& di, std::vector<sinfo>& svold, std::vector<sinfo>& svnew,  arma::vec GAMMA_QUANT,
                     arma::vec TAU_SQ_QUANT);
...
//bool calirotp_new(tree::tree_p tnew, tree& x, xinfo& xi, dinfo& di, pinfo& pi, double GAMMA_QUANT, double TAU_SQ_QUANT, size_t minperbot);
...
void getpertsuff_new(tree& x, tree::tree_p pertnode, tree::npv& bnv, size_t oldc, size_t oldv, bool didswaplr, xinfo& xi, dinfo& di, std::vector<sinfo>& svold, std::vector<sinfo>& svnew, arma::vec GAMMA_QUANT,
                     arma::vec TAU_SQ_QUANT);
