...
public:
  ...
  //------------------------------
   ...
   //------------------------------
   //friends
    friend bool bd(tree& x, xinfo& xi, dinfo& di, pinfo& pi, arma::vec GAMMA_QUANT,
                   arma::vec TAU_SQ_QUANT, size_t min_obs_node,std::vector<int>& varused, size_t maxdepth);
   ...
   friend void getpertsuff_new(tree& x, tree::tree_p pertnode, tree::npv& bnv, size_t oldc, size_t oldvar, bool didswaplr, xinfo& xi, dinfo& di, std::vector<sinfo>& svold, std::vector<sinfo>& svnew, arma::vec GAMMA_QUANT,
   ...
   friend bool merge2triv(tree::tree_p tl, tree::tree_p tr, tree::tree_p t, size_t v, size_t c);
	...
	friend bool calirotp_new(tree::tree_p tnew, tree& x, xinfo& xi, dinfo& di, pinfo& pi,arma::vec GAMMA_QUANT,
	...
	friend void calichgv_new(tree& x, xinfo& xi, dinfo& di, pinfo& pi,arma::vec GAMMA_QUANT,
                   arma::vec TAU_SQ_QUANT, size_t minperbot); 
   //------------------------------
